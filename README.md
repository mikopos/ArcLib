...
[Arcs are in geometry a closed segment of differentiable curve](https://en.wikipedia.org/wiki/Arc_(geometry) In OpenLayers creating an arc might be a messy and confusing task, as there is no embedded way to do this.
